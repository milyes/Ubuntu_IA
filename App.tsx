...
const App: React.FC = () => {
  ...
  const [windows, setWindows] = useState<WindowState[]>([
    ...
    { id: 'ai-chat', title: 'Chat IA - Assistant Neuronal', isOpen: true, isMaximized: false, zIndex: 11 },
  ...
  const [highestZ, setHighestZ] = useState(11);
